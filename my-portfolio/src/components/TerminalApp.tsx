...
const COMMANDS: Record<string, (args: string[]) => Line[]> = {
  ...
  projects: () => [
    ...
    { type: 'blank', content: '' },
    { type: 'output', content: '1. 🤖 AI-Powered Essay Evaluation & Scoring System for Teachers' },
    { type: 'output', content: '      └─ React, Node.js, MongoDB, Gemini AI, PWA, Tailwind CSS, Docker' },
    { type: 'blank', content: '' },
    { type: 'output', content: '2. 🚗 Smart Parking Management System with Plate Number Recognition' },
    { type: 'output', content: '      └─ Firebase, Python, YOLO, Flask, Computer Vision' },
    { type: 'blank', content: '' },
    { type: 'output', content: '3. 📋 Santa Maria Barangay Document Request System with Customer Support Chatbot' },
    { type: 'output', content: '      └─ PHP, HTML, CSS, MySQL, Bootstrap' },
    { type: 'blank', content: '' },
    { type: 'output', content: '4. 🍳 Recipe System with Customer Support Chatbot' },
    { type: 'output', content: '      └─ PHP, MySQL, Bootstrap' },
    { type: 'blank', content: '' },
    { type: 'output', content: '5. 📱 Quiz App' },
    { type: 'output', content: '      └─ Flutter, Firebase' },
    { type: 'blank', content: '' },
    { type: 'output', content: '6. 🛒 E-commerce Website' },
