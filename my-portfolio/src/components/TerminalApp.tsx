...
const COMMANDS: Record<string, (args: string[]) => Line[]> = {
  ...
  about: () => [
    ...
    { type: 'output', content: '│  (Web & Mobile) PSU Urdaneta. Current MIT Student at UdD │' },
  ...
  skills: () => [
    ...
    { type: 'output', content: '   Web: PHP, Laravel, HTML, CSS, JS, Bootstrap, MySQL, Node.js' },
    { type: 'output', content: '   Mobile: Dart, Flutter, Firebase' },
    { type: 'output', content: '   Programming: Java, Java GUI, C++, Python Flask' },
    { type: 'output', content: '   Tools: Figma, WordPress, Postman' },
    { type: 'blank', content: '' },
  ],
  ...
  projects: () => [
    ...
    { type: 'blank', content: '' },
    { type: 'output', content: '1. 🚗 Smart Parking Management System with Plate Number Recognition' },
    { type: 'output', content: '      └─ Firebase, Python, YOLO, Flask, Computer Vision' },
    { type: 'blank', content: '' },
    { type: 'output', content: '2. 📋 Santa Maria Barangay Document Request System with Customer Support Chatbot' },
    { type: 'output', content: '      └─ PHP, HTML, CSS, MySQL, Bootstrap' },
    { type: 'blank', content: '' },
    { type: 'output', content: '3. 🍳 Recipe System with Customer Support Chatbot' },
    { type: 'output', content: '      └─ PHP, MySQL, Bootstrap' },
    { type: 'blank', content: '' },
    { type: 'output', content: '4. 📱 Quiz App' },
    { type: 'output', content: '      └─ Flutter, Firebase' },
    { type: 'blank', content: '' },
    { type: 'output', content: '5. 🛒 E-commerce Website' },
    { type: 'output', content: '      └─ Laravel, MySQL' },
    { type: 'blank', content: '' },
  ],
